...
import fav from '../../images/cardModalImg/fav.svg'
                    ...
                    <div className={classes.modal_inner}>
                        ...
                        <div className={classes.block_reviwes}>
                            ...
                            <div className={classes.text}>
                                ...
                                происхождения, располагающееся в юго-восточной
                                части Нарынской области, близ
                                кыргызско-китайской границы, на высоте 3500
                                метров. Озеро потрясает своими видами — вода в
                                нем ярко-голубого цвета и очень красиво
                                контрастирует с окружающими его суровыми
                                скалами. Это одно из самых красивых, и вместе с
                                тем труднодоступных мест в Кыргызстане.Кель-Суу
                                — это озеро завального типа, образованное в
                                большой расщелине между скалами. С берега не
                                видно большей его части, а потому чтобы увидеть
                                озеро целиком, нужно плыть по нему на лодке.
                                Длина озера составляет 9 километров, а ширина —
                                варьируется от 500 метров до 2-х километров в
                                самом широком месте.У озера имеется одна
                                необычная особенность, в честь которой и ему и
                                было дано такое название: Кель-Суу в переводе с
                                кыргызского переводится как «преходящая вода». И
                                действительно, иногда вода пропадает, утекая в
                                подземные пещеры и гроты, а потому перед
                                поездкой туда нужно иметь ввиду, что озеро можно
                                и не застать, однако и в этом случае вам
                                откроются инопланетные пейзажи со скалами.Озеро
                                находится на труднодоступном хребте Кокшаал-Тоо,
                                а путь туда лежит через обширную Ак-Сайскую
                                долину и изобилует болотистыми местами и
                                бродами, справиться с которыми может только
                                подготовленный автомобиль и опытный водитель.
                                Сама дорога к озеру от лагеря тоже живописна:
                                высокогорные пастбища, реки, стада яков и пики
                                ледников на горизонте не оставят никого
                                равнодушным.
                            </div>
                            <div className={classes.reviwes}>
                                ...
                                <img
                                    src={penImg}
                                    alt="pen"
                                    className={classes.icon_pen}
                                    onClick={heandleOpenReviews}
                                />
                            </div>
                            <Reviews />
                            <Reviews />
                ...
                <div className={notActive} style={{width: "32px", height: "32px", }}>
                      ...
                      animationDuration={0.1} style={{width: '20px', height: '18px'}}/>
                            ...
                            <div className={classes.heart_header}>
                                ...
                                <h1 className={classes.heart_text}>
                                    Сулайман-Тоо
                                </h1>
                            </div>
                            ...
                            <div className={classes.location_and_level}>
                                ...
                                <div className={classes.level}>
                                    ...
                                    />
                                    <div className={classes.level_text}>
                                        Сложность
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className={classes.duration_and_price}>
                                <div className={classes.duration}>
                                    <img
                                        scr={regionImg}
                                        alt="r"
                                        className={classes.duration_image}
                                    />
                            ...
                            <div className={classes.user_choice_two}>
                                ...
                                <div className={classes.choice_price}>
                                    <div className={classes.price_number}>
                                        5000
                                    </div>
                            ...
                            <div className={classes.rating_and_guide}>
                                ...
                                <div className={classes.walker_and_google}>
                                    <div className={classes.display}>
                                        <div className={classes.walker}>
                                            <img
                                                scr={walkerImg}
                                                alt="w"
                                                className={classes.walker_image}
                                            />
                                            <div
                                                className={classes.walker_text}
                                            >
                                                Пеший
                                            </div>
                                            <div
                                                className={
                                                    classes.walker_text_two
                                                }
                                            >
                                                тур
                                            </div>
                                        ...
                                        <div className={classes.google}>
                                            ...
                                            >
                                                <img
                                                    ...
                                                    alt="g"
                                                    className={
                                                        classes.google_image
                                                    }
                                                />
                                                <div
                                                    className={
                                                        classes.google_text_main
                                                    }
                                                >
                                                    <div
                                                        className={
                                    ...
                                    <div className={classes.guide}>
                                        <div
                                            className={
                                                classes.guide_text_and_image_h
                                            }
                                        >
                                            <div
                                                className={
                                                    classes.guide_text_and_image
                                                }
                                            >
                                                <img
                                                    scr={guideImg}
                                            ...
                                            <img
                                                scr={vasyaImg}
                                                alt="vasya"
                                                className={classes.vasya_image}
                                            />
                                            <div className={classes.vasya_text}>
                                                Вася Пупкин
                                            </div>
                                        </div>
                                    </div>
